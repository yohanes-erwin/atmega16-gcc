...
// Three LCD control lines and four LCD data lines 
// can be on same port or on different ports
#define LCD16X2_PORT_RS	PORTD
#define LCD16X2_PORT_RW	PORTC
#define LCD16X2_PORT_EN	PORTC
#define LCD16X2_PORT_D4	PORTC
#define LCD16X2_PORT_D5	PORTC
#define LCD16X2_PORT_D6	PORTC
#define LCD16X2_PORT_D7	PORTC
// Pin definition
#define LCD16X2_PIN_RS	7
#define LCD16X2_PIN_RW	2
#define LCD16X2_PIN_EN	3
#define LCD16X2_PIN_D4	4	// 4-bit mode LSB
#define LCD16X2_PIN_D5	5
#define LCD16X2_PIN_D6	6
#define LCD16X2_PIN_D7	7	// 4-bit mode MSB
